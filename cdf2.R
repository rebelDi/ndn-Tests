...
#
#data1 <- read.csv("pro01-1-1-1ChoicePercentage.csv", header=F, sep="\t")
#data2 <- read.csv("re01-1-1-1ChoicePercentage.csv", header=F, sep="\t")
...
#pdf(file="ChoicePercentage-01-1-1-1.pdf", paper="special", width=7, height=4)
#
...
data1 <- read.csv("pro01-5-1-1SortedLatencies_normal.csv", header=F, sep="\t")
data2 <- read.csv("re01-1-1-1SortedLatencies_normal.csv", header=F, sep="\t")

pdf(file="LAT_CDF-01-5-1-1.pdf", paper="special", width=7, height=4)
#
par(mar=c(3.3, 4.5, 1.5, 0.3))
par(mgp = c(2, 1, 0))
#
